# Generated by Django 5.1 on 2025-06-05 02:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='e.g. Quizzes, Assignments', max_length=100)),
                ('best_of_count', models.PositiveIntegerField(blank=True, help_text='Consider best N scores', null=True)),
                ('course_assignment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.courseassignment')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='components', to='api.evaluationgroup')),
            ],
        ),
        migrations.CreateModel(
            name='Professor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('component', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.evaluationcomponent')),
